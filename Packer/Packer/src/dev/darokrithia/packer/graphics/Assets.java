...
public class Assets {
	...
	public static void init(){
		packerSpriteSheet = new SpriteSheetHandler("/images/packerSpriteSheet.png");
		...
		enemySpriteSheet = new SpriteSheetHandler("/images/enemySpriteSheet.png");
		...
		alliedSpriteSheet = new SpriteSheetHandler("/images/hackedSpriteSheet.png");
		...
		deadEnemySpriteSheet = new SpriteSheetHandler("/images/deadEnemySpriteSheet.png");
		deadEnemy = deadEnemySpriteSheet.selectImage(0, 0, 32, 32);
		finalEnemySpriteSheet = new SpriteSheetHandler("/images/evilComputer.png");
		finalEnemy = finalEnemySpriteSheet.selectImage(0, 0, 128, 128);
		
		bulletSpriteSheet = new SpriteSheetHandler("/images/projectileSpriteSheet.png");
		...
		tileSpriteSheet = new SpriteSheetHandler("/images/tileSpriteSheet.png");
		...
		hackText = new SpriteSheetHandler("/images/hackText.png");
		
		winText = new SpriteSheetHandler("/images/winScreen.png");
		win = winText.selectImage(0, 0, 512, 512);
		loseText = new SpriteSheetHandler("/images/loseScreen.png");
